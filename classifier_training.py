...
parser.add_argument('--resume_training', default=False, type=bool, help='Flag to resume training from chekpoint')
...
### Training
def train(model, train_loader, test_loader, start_epoch, end_epoch, op_folder, bs, resume_training=False):
...
if __name__ == "__main__":
    ...
    train(model, train_loader, test_loader, start_epoch, end_epoch, args.output_path, args.batch_size, args.resume_training)
